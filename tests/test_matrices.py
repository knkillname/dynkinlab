...
class TestInfiniteMatrix(unittest.TestCase):
    ...
    def test_instantiation_with_data(self):
        ...
        m = matrices.InfMatrix(data=[(0, 0, 1), (1, 1, 2), (1, 0, 3)], dtype=int)
    ...
    def test_infer_dtype(self):
        ...
        m = matrices.InfMatrix(data=[(0, 0, 1), (1, 1, 2), (1, 0, 3), (0, 1, 4)])
        self.assertEqual(m.dtype, int)
        m = matrices.InfMatrix(data=[(0, 0, 1.0), (1, 1, 2.0)])
